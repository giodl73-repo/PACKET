...
| `2026-06-26-packet-implementation` | planned | Build WP-001..006 bottom-up, one work package per pulse (pulses 01–06). No code until executed. |

## Active wave

- `2026-06-26-packet-implementation` (all pulses defined; pending execution)
...
5. Keep mission-level files free of scoring, gap, or design content, and declare scale
   where relevant.
6. Update docs and wave/pulse status.
7. Run the repo validation commands.
8. Commit when the stage/work package is settled and validated.
